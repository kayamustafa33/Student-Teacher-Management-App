...
public class NoticeAdapter extends RecyclerView.Adapter<NoticeAdapter.NoticeViewAdapter> {
    ...
    public void onBindViewHolder(@NonNull NoticeViewAdapter holder, int position) {
        ...
        //holder işlemi layout ile bağlandı
        holder.deleteNoticeTitle.setText(currentItem.getTitle());

        //eğer resim boş değilse layouta bağlandı
        try{
            if (currentItem.getImage() != null)
            Picasso.get().load(currentItem.getImage()).into(holder.deleteNoticeİmage);
        }catch (Exception e){
            e.printStackTrace();
        }

        //item silme işlemi için firebaseden yararlandık
    ...
    public class NoticeViewAdapter extends RecyclerView.ViewHolder {
        ...
        private ImageView deleteNoticeİmage;
        ...
        public NoticeViewAdapter(@NonNull View itemView) {
            ...
            deleteNoticeİmage = itemView.findViewById(R.id.deleteNoticeİmage);
