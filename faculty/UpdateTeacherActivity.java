...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //layour elemanları initialize edildi
        ...
        //resim boş değil ise verisi alır
        try {
    ...
    private void deleteData() {
        //veritabanına erişip veriyi sildik
        reference.child(category).child(uniqueKey).removeValue()
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        Toast.makeText(UpdateTeacherActivity.this, "Öğretmen Silinmesi Başarılı", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(UpdateTeacherActivity.this, "Bir şeyler ters gitti", Toast.LENGTH_SHORT).show();
                    }
                });
    }
    ...
    private void checkValidation() {
        if (name.isEmpty()){
            updateTeacherName.setError("Boş");
            updateTeacherName.requestFocus();
        }else if (name.isEmpty()){
            updateTeacherPost.setError("Boş");
            updateTeacherPost.requestFocus();
        }else if (email.isEmpty()){
            updateTeacherEmail.setError("Boş");
    ...
    private void updateData(String s) {
        ...
        //hashmap ile verileri bir yerde tuttuk
        ...
        reference.child(category).child(uniqueKey).updateChildren(hp).addOnSuccessListener(new OnSuccessListener() {
            ...
            public void onSuccess(Object o) {
                Toast.makeText(UpdateTeacherActivity.this, "Öğretmen güncellemesi Başarılı", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(UpdateTeacherActivity.this,UpdateFaculty.class);
                intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
        ...
        uploadTask.addOnCompleteListener(UpdateTeacherActivity.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                ...
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(UpdateTeacherActivity.this, "Bir hata oluştu!", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
